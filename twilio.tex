...
\begin{tikzpicture}
  ...
  \node[minimum height=2cm,minimum width=3cm,draw, align=center] (Administración) at (6,3){\textbf{Administracion} \\
  ...
  \node[minimum height=2cm,minimum width=3cm,draw, align=center] (Autogeneradores) at (-6,0){\textbf{Licencia} \\ MIT License};
  ...
  \node[minimum height=2cm,minimum width=3cm,draw, align=center] (Dependencias) at (6,-3){\textbf{Licencia} \\ MIT License};

  \node[minimum height=2cm,minimum width=3cm,draw, align=center] (Herramientas de Soporte) at (-6,-3){\textbf{Licencia} \\ MIT License};
  ...
  \draw[thick,->] (Twilio.north) -- (Usuarios.south);
  \draw[thick,->] (Twilio.north) -- (Licencia.south);
\end{tikzpicture}  
...
\begin{tikzpicture}[node distance=2cm]
  ...
  \node[parallelepiped,draw=black,fill=white,minimum width=4.6cm,minimum height=3cm] at (-0.3,-0.8) {};
  ...
  \node [align=center, draw]  (API) at (7,0) {<<api>>\\ \textbf{Twilio API}};

  \draw[thick,->] (3.4,0) -- (5.5,0);
 
\end{tikzpicture}

\hfill\\
La librería twilio-python requiere de un interprete de Python para ejecutarse correctamente, ademas necesita acceso a la API de Twilio via internet.
