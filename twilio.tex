...
\title{%
  ...
  the Twilio API and generating TwiML TODO!} 
...
\begin{itemize}
  ...
  a otros participantes. Los desarrolladores en su momento
...
\cite{twilio-license},
permitiendo a sus usuarios, otros desarolladores,
...
Esta se realiza llamando al método correspondiente
de las clases que representan los recursos de la librería.
...
la librería se puede usarse sin miedo a que se abandonada.
